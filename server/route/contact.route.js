...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        await transporter.sendMail({
            ...
            html: `<h1>Hi ${name},</h1><p>Thank you for reaching out to us. We have received your message and will get back to you soon.</p><br><p>Regards,<br>Your Bookstore Team</p>`,
        });
